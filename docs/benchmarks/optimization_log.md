...
| `reliable-desktop-restart` | `fddfed7`, `e6653c8`, `dbd6251` | Thor launch/container | Add idempotent background restart, GNOME session discovery, RealSense color-device discovery, and readiness checks | manual environment/export plus stale-launch failures | warm container reuse and forced cold container recreation both opened mode 2/TV5M at 848x480@60 | n/a | n/a | cold GI load still takes about 90 s | same engines, precision, and camera profile | accept |
